...
REM Setup Variables
REM =============================
set appname=Airdragon
set dev=Rama
set desc=A file who saves all wifi credentials
set uicolor=a
set infouicolor=b
set erruicolor=c
set cliN=$%appname%
...
echo # %divider%
echo #
echo # WiFi credentials has been saved to "creds.txt", Press any key to continue 
pause>null
goto mainMenu
